<template>
	<div class="container has-text-centered">
		<div class="columns">
		  <div class="column">
		  	<div class="tile">
			  <article class="tile is-child notification is-success-radius">
		...
		<nav class="level">
		  <div class="level-item has-text-centered">
		    <div>
		      ...
		      <p class="title">
		      	<a href="https://twitter.com/SudhanSubedi">
		  ...
		  <div class="level-item has-text-centered">
		    <div>
		      ...
		      <p class="title">
		      	<a href="https://www.facebook.com/sudhan.subedi.31">
		  ...
		  <div class="level-item has-text-centered">
		    <div>
		      ...
		      <p class="title">
		      	<a href="https://www.instagram.com/madhusudhansubedi/">
		  ...
		  <div class="level-item has-text-centered">
		    <div>
		      ...
		      <p class="title">
		      	<a href="https://www.linkedin.com/in/madhusudhan1994/">
